...
export default async function AppLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <SidebarProvider>
      <AppSidebar evidenceEnabled={evidenceEnabled() || publicEvidenceDemoEnabled()} firmName={firm.name} clients={clients} reviewCounts={reviewCounts} demoMode={process.env.DEMO_MODE === "true"} />
