...
export default async function ReportsPage({ searchParams }: { searchParams: WorkspaceSearchParams }) {
  ...
  return <div className="space-y-6"><PageHeader title="Laporan" description="Laporan keuangan dari jurnal yang sudah dibukukan." /><WorkspaceScopeBar scope={data.scope} /><NextStep>Pilih angka untuk membuka laporan perusahaan dan menelusuri jurnal sumbernya.</NextStep><WorkspaceFinancials data={data} /></div>;
}
