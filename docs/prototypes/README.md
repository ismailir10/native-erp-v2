...
3. Change scope from **Semua klien** to **Grup Nusa** to **PT Nusa Niaga**. Each view uses the same period; old answers preserve their original scope and values under the history button.
...
6. Follow **Buku Besar → Laporan → Tutup buku**. Profit is now Rp 35,600,000; cash remains Rp 135,600,000. Confirm the sign-off to close the period.
