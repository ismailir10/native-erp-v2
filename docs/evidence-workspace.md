...
- On Vercel, `VERCEL_ENV=preview` and `EVIDENCE_PRIVATE_DEPLOYMENT=true` are additionally required. Enable this only on a deployment actually protected by Vercel login. Production and the public demo stay disabled.
