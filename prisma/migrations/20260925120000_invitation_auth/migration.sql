...
-- CreateIndex
CREATE INDEX "AuthUser_firmId_idx" ON "AuthUser"("firmId");
...
-- AddForeignKey
ALTER TABLE "AuthUser" ADD CONSTRAINT "AuthUser_firmId_fkey" FOREIGN KEY ("firmId") REFERENCES "Firm"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
